...
class SqsCreatorService:
    ...
    def create_queue(self, queue_name: str, redrive_policy: SqsRedrivePolicy | None = None) -> SqsQueue:
        ...
        if redrive_policy:
            response = self.sqs_client.create_queue(
                ...
                Attributes=json.dumps(redrive_policy.to_dict())
            )
    ...
    def get_queue_attributes(self, queue_url: str) -> SqsQueueAttributes:
        ...
        return SqsQueueAttributes(
            ...
            aprox_number_of_messages_in_transit=int(response["ApproximateNumberOfMessagesNotVisible"])
        )
